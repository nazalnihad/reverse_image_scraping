...
def main(reference_folder, save_path, num_images_to_process=10):
...
if __name__ == '__main__':
    ...
    num_images_to_process = 10  # Change this to the number of random images you want to process
    main(reference_folder, save_path, num_images_to_process)